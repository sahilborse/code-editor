      ...
      <Container fluid style={body}>
        ...
        >
          <Col md={6} className="text-center">
            ...
            <TextareaAutosize
                // id="textarea_input"
                onChange={handelChange}  // Make sure the handler is properly named as 'handleChange'
                value={userInput}
                style={mdIn}
                minRows={31}  // Optionally set minimum rows
                maxRows={100}  // Optionally set maximum rows
                />
          </Col>
